...
//-------------------------------------------------------------------------------------------------
 ...
 dcl-proc removeUnprintable_hexC;
    ...
    assertCharEquals( '{ABCDEFGHIÙˆÚÛı'
 ...
 dcl-proc removeUnprintable_hexF;
    ...
    assertCharEquals( '0123456789€‹Ÿ⁄' + x'FF'
